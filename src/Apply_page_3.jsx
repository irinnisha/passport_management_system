                        ...
                        <div class="form_field form_field_page3">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><input placeholder="Enter your postal code" type="text" /></td>
                                </tr>
                                <tr>
                                    <td><label>City/Village/House (): </label></td>
                                    <td><input placeholder="Enter your city/village/house" type="text" /></td>
                                </tr>
                                <tr>
                                    <td><label>Road/Block/Sector (): </label></td>
                                    <td><input placeholder="Enter your road/block/sector" type="text" /></td>
                                </tr>
                            </table>
                        </div>
                        <div class="form_header">
